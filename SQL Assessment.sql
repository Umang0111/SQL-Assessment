...
-- que.2
select country_name_eng from country left join city
on country.id=city.country_id left join customer on customer.city_id=city.id where customer_name is null;